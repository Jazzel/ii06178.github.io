        ...
        return(
            ...
            <div className="row">
              <div className="col-lg-6">
                ...
                <div className="card">
                  <div className="card-body">
                    <h5 className="card-title">Student Attendence Form</h5>
                    ...
                    <form>
                      ...
                      <div className="row mb-3">
                        <label htmlFor="inputText" className="col-sm-2 col-form-label">Role</label>
                        <div className="col-sm-10">
                          <input type="text" className="form-control"/>
                      ...
                      <div className="row mb-3">
                        <label className="col-sm-2 col-form-label">Attendence</label>
                        <div className="col-sm-10">
                      ...
                      <div className="row mb-3">
                        <label className="col-sm-2 col-form-label">Tickets Bought</label>
                        <div className="col-sm-10">
                          <select className="form-select" aria-label="Default select example">
                            <option selected>Open this select menu</option>
              ...
              <div className="col-lg-6">
                ...
                <div className="card">
                  <div className="card-body">
                    <h5 className="card-title">Guest Attendence Form</h5>
...
<div className="card">
  <div className="card-body">
    ...
    <form>
      <div className="row mb-3">
        <label htmlFor="inputText" className="col-sm-2 col-form-label">Role Name</label>
        <div className="col-sm-10">
          <input type="text" className="form-control" />

                ...
                <div class="container py-5">
                    <div class="row g-5">
                        <div class="col-lg-3 col-md-6">
                            ...
                            <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Habib University</p>
                            {/* <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+012 345 67890</p> */}
                            <p class="mb-2"><i class="fa fa-envelope me-3"></i>connectionverse@gmail.com</p>
                            <div class="d-flex pt-2">
                                ...
                                <a class="btn btn-square btn-outline-secondary rounded-circle me-2" href=""><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">

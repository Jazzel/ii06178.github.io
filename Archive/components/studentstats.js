          ...
          <div className="row">
            ...
            <div className="col-xxl-4 col-md-6">
              <div className="card info-card sales-card">
                ...
                <div className="card-body">
                  <h5 className="card-title">Upcoming Event<span>| This Week</span></h5>
            ...
            <div className="col-xxl-4 col-md-6">
              <div className="card info-card revenue-card">
                ...
                <div className="card-body">
                  <h5 className="card-title">Revenue From Tickets <span>| This Month</span></h5>
              ...
              <div className="card info-card customers-card">
                ...
                <div className="filter">
                  ...
                  <ul className="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <li><a className="dropdown-item" href="#">Today</a></li>
                    <li><a className="dropdown-item" href="#">This Semester</a></li>
                    <li><a className="dropdown-item" href="#">This Year</a></li>
                  </ul>
                </div>

                <div className="card-body">
                  <h5 className="card-title">Number of Students<span>| This Semester</span></h5>
            ...
            <div className="col-12">
              <div className="card top-selling overflow-auto">
                ...
                <div className="card-body pb-0">
                  <h5 className="card-title">Top Events<span>| This Semester</span></h5>
